...
/**
 * Provides the local service interface for ShortUrl. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author David
 * @see ShortUrlLocalServiceUtil
...
public interface ShortUrlLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ShortUrlLocalServiceUtil} to access the short url local service. Add custom service methods to {@link de.ancud.shorturl.service.impl.ShortUrlLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
